...
title('Noisy Image (Salt and Pepper)')
 ...
 subplot(2,3,4)
imhist(im_saltp)
 title('Histogram of Noisy Image (Salt and Pepper)')
...
% subplot(2,2,2);
% imhist(lena);
% title('Historam of Original Image');
% 
% subplot(2,2,3);
% imshow(uint8(im_saltp));
% title('Noisy Image (Salt-and-Pepper)');
% 
% subplot(2,2,4);
% imhist(uint8(im_saltp));
% title('Histogram of Salt-and-Pepper Noisy Image');